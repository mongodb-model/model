...
belongsToEmbedded(Model, foreignKey, ownerkey){}

hasOneReferencial(Model, foreignKey, localkey){}
hasOneEmbedded(Model, foreignKey, localkey){}


hasManyReferencial(Model, foreignKey, ownerkey){}
hasManyEmbedded(Model, foreignKey, ownerkey){}


belongsToManyReferencial(){}
belongsToManyEmbedded(){}
