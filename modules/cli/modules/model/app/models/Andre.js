...
|--------------------------------------------------------------------------------
|
| Andre extends the base model (Model) class and thus has everything
...
class Andre extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'andres', url: 'undefined', db: 'undefined'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'andres';
