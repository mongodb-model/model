...
|--------------------------------------------------------------------------------
|
| Victoria extends the base model (Model) class and thus has everything
...
class Victoria extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'victorias', url: 'undefined', db: 'undefined'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'victorias';
