...
(global => {
    ...
    */
        ...
        */
        ...
        const centered =  () => `\x1b[36mNAME\x1b[0m
         ...
         const man = (Obervable) => {
              ...
              //this.horizontalLine()
              Obervable.description(centered)
              //this.horizontalLine()
              Obervable.verticalSpace(2)
  
              const options = { pad: 13, position: process.stdout.columns, hline: false, keyColor: '36', valueColor: '37' }
              Obervable.textAligner(options, commands)
              console.log()
         }
        const cmdText = () => ({})
    ...
    | the cmdText object by assigning it to module.exports
    |
    |
    */
    
    if (typeof module !== 'undefined' && module.exports)  module.exports = cmdText;
    ...
    | in the browser) by assigning it to global.cmdText.
    |
    */

    else global.cmdText = cmdText;
})(this)