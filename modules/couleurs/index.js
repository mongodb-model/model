...
(global => {
    ...
    */
    ...
    | the couleurs object by assigning it to module.exports
    |
    |
    */

    if (typeof module !== 'undefined' && module.exports) module.exports = couleurs;
    ...
    | in the browser) by assigning it to global.couleurs.
    |
    */

    else global.couleurs = couleurs;
})(this)